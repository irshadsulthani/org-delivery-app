...
type AuthMode = 'login' | 'signup' | 'forgotPassword' | 'resetPassword' | 'verifyOtp' | 'verifyForgotPassword';
...
const handleVerifyOtp = async () => {
  ...
  const getTitle = () => {
    switch (authMode) {
      ...
      case 'verifyForgotPassword': return 'Verify OTP';
      default: return '';
    }
  };
  ...
  const getSubtitle = () => {
    switch (authMode) {
      case 'login': return 'Log in to your retailer account';
      case 'signup': return 'Create your retailer account today';
          ...
          <div className="p-8">
            <div className="text-center mb-8">
              <div className={`h-16 w-16 ${
                authMode === 'verifyOtp' || authMode === 'verifyForgotPassword' || authMode === 'forgotPassword' 
            ...
            {verificationSuccess && authMode === 'verifyOtp' ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                {(authMode !== 'verifyOtp' && authMode !== 'verifyForgotPassword') && (
                  <button
                    type="submit"
                    disabled={isLoading}
