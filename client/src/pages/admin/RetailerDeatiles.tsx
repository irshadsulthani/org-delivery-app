...
import { getRetailerById,  blockRetailer, unblockRetailer } from "../../api/adminApi";
...
function RetailerDetailsPage() {
  ...
  const getAverageRating = () => {
    ...
    const totalRating = retailer.reviews.reduce((sum, review) => sum + review.rating, 0);
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6 border border-gray-200">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center">
                ...
                <div className="flex-1">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-2 gap-2">
                    <h1 className="text-2xl font-bold text-white">{retailer.shopName}</h1>
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                      ...
                      {retailer.isVerified ? 'Verified Shop' : 'Pending Verification'}
                    </span>
                    ...
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-white text-blue-800">
                      ...
                      Joined {formatDate(retailer.createdAt).split(' ').slice(0, 2).join(' ')}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 border-b border-gray-200 bg-white">
              <div className="p-5 border-r border-gray-200 flex flex-col items-center justify-center">
                ...
                <div className="flex items-center">
                  <p className="text-2xl font-bold text-gray-800">{getAverageRating()}</p>
              ...
              <div className="p-5 border-r border-gray-200 flex flex-col items-center justify-center">
                <div className="flex items-center justify-center mb-2 h-10 w-10 rounded-full bg-blue-100">
                  <ShieldCheck size={20} className={retailer.userId.isBlocked ? "text-red-600" : "text-green-600"} />
                </div>
                <p className="text-sm text-gray-500 text-center">Status</p>
                <p className={`text-xl font-bold ${retailer.userId.isBlocked ? "text-red-600" : "text-green-600"}`}>
            ...
            <div className="p-6">
              {activeTab === "shop" && (
                <div className="bg-white rounded-lg">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{retailer.shopName}</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{retailer.userId.name}</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{retailer.userId.email}</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                      ...
                      <div className="flex items-start">
                        <CheckCircle2 size={20} className="mr-3 text-blue-600 mt-1" />
                        <div>
                          <p className="text-sm font-medium text-gray-500">Verification Status</p>
                          <p className={`font-medium ${retailer.isVerified ? "text-green-600" : "text-yellow-600"}`}>
                  ...
                  {/* Shop description */}
                  <div className="mt-6">
                    <h3 className="text-lg font-medium text-gray-900 mb-2">Shop Description</h3>
              ...
              {activeTab === "address" && (
                <div className="bg-white rounded-lg">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="flex items-start">
                        <Building size={20} className="mr-3 text-blue-600 mt-1" />
                        <div>
                          <p className="text-sm font-medium text-gray-500">Street</p>
                          <p className="font-medium text-gray-900">{retailer.address.street || "Not provided"}</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{retailer.address.area || "Not provided"}</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        <MapPin size={20} className="mr-3 text-blue-600 mt-1" />
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{retailer.address.city || "Not provided"}</p>
                        </div>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="flex items-start">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{retailer.address.state || "Not provided"}</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        <FileText size={20} className="mr-3 text-blue-600 mt-1" />
                        <div>
                          <p className="text-sm font-medium text-gray-500">Zip Code</p>
                          <p className="font-medium text-gray-900">{retailer.address.zipCode || "Not provided"}</p>
                        </div>
                      </div>
                      <div className="flex items-start">
                        <MapPin size={20} className="mr-3 text-blue-600 mt-1" />
                        <div>
                          ...
                          <p className="font-medium text-gray-900">{retailer.address.country || "Not provided"}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="p-4">
                        {retailer.shopImageUrl ? (
                          ...
                          <div className="text-center py-8 bg-gray-50 rounded-md">
                            <FileImage size={24} className="mx-auto text-gray-400 mb-2" />
                            <p className="text-gray-500">No shop image uploaded</p>
                          </div>
                        )}
                      </div>
                    </div>
                            ...
                            <div className="w-full h-64 bg-gray-100 rounded-md overflow-hidden mb-3 flex items-center justify-center">
                              {licenseImageError ? (
                                <div className="text-center p-4">
                                  ...
                                  <p className="text-gray-500">Could not display license document</p>
                                  <a 
